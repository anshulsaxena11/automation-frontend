...
export const srpiEmpTypeListActive = async({ page = 1, limit = 10, search =" " ,centre="",etpe=" ",dir="",projectId=""} = {}) => axiosInstance.get('/user/stpiEmp', { params: { page, limit, search,centre,etpe,projectId,dir } }).then(response => response.data);
